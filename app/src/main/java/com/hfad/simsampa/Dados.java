...
public class Dados extends AppCompatActivity{
    ...
    String[] secretarias = {"Secretaria Municipal de Habitação", "Secretaria Municipal de Educação", "Secretaria Municipal de Transportes", "Secretaria Municipal de Infraestrutura Urbana e Obras"};
